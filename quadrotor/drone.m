...
##   ];
  d = 0.05;
  d_struct.drone_vertex = [
    [0, d_struct.arm_len, d_struct.arm_len, d_struct.arm_len, 0, -d_struct.arm_len, -d_struct.arm_len, -d_struct.arm_len, -d_struct.arm_len, 0, -d_struct.arm_len, -l, -l, -l, 0, l, l, l, l];
